...
export const Route = createFileRoute("/inscription")({
  head: () => ({
    meta: [
      { title: "Inscription — Keau-Nzi" },
      { name: "description", content: "Créez votre compte Keau-Nzi" },
    ],
  }),
    ...
    <section className="py-16 md:py-24">
      <div className="container-spirit max-w-md mx-auto">
        <div className="text-center mb-10">
          <p className="text-xs uppercase tracking-[0.4em] text-gold mb-3">Rejoignez-nous</p>
          <h1 className="text-3xl md:text-4xl font-display">Créer un compte</h1>
        </div>
        ...
        <div className="rounded-lg border border-border bg-card p-6 md:p-8">
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Déjà un compte ?{" "}
            <Link to="/connexion" className="text-gold hover:underline">Se connecter</Link>
          </p>
        </div>
      </div>
    </section>
